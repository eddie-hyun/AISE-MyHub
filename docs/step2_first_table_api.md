...
> 📌 **AI가 만든 초안을 그대로 쓰지는 않았습니다.** 2-4장의 SQL과 같은 이유입니다 — 어떤 컬럼을 어떤 방식으로 읽어올지는 프롬프트가 정해준 게 아니라 **AI가 그때그때 고른 것**이라, 같은 프롬프트를 다시 줘도 다른 모양이 나올 수 있습니다.
